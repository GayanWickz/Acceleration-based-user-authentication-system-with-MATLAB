...
Input_Features(:, 1:numFeatures) = Input_Features(:, 1:numFeatures) .* featureWeights;
    ...
    hiddenLayerSize = [30,20,10]; "https://in.mathworks.com/help/deeplearning/ref/feedforwardnet.html"
    
    % Train the NN.  "https://in.mathworks.com/help/deeplearning/ref/feedforwardnet.html"
    ...
    predictedLabels = round(output); % Convert scores to binary (0 or 1)
     ...
     % Calculate FAR and FRR at multiple thresholds "https://in.mathworks.com/matlabcentral/answers/2047492-how-to-draw-roc-curve-for-equal-error-rate-far-vs-frr"
