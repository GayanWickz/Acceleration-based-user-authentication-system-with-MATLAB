...
for userID = 1:numUsers
    ...
    trainDataFile = sprintf('User%02d_TD_train_Template.mat', userID);
...
Input_Features(:, 1:numFeatures) = Input_Features(:, 1:numFeatures) .* featureWeights;
    ...
    testDataFile = sprintf('User%02d_TD_test_Template.mat', userID);
